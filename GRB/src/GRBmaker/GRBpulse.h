...
class GRBpulse
{
 public:
	 ...
	 // Returns pulse data
	 long data(HepRandomEngine *engine, const long nphoton, const int npuls, const double duration);
 ...
 private:
	 ...
	 void pickWidth(HepRandomEngine *engine, const double duration);

	 // calculates the universal width for the pulses in the given burst
	 void universalWidth(HepRandomEngine *engine, const double duration, const long diff, const long minval, 
