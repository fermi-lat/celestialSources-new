...
public:
      ...
      * \brief Constructor.
      */
    LatGrb(CLHEP::HepRandomEngine *engine, const std::string &prefix, 
        const std::string &dir=0);
    
     /*!
      * \brief Constructor.
      */
    LatGrb(CLHEP::HepRandomEngine *engine, const double duration, const int npuls, 
...
private:
    ...
    */
    void calcSpecnorm(CLHEP::HepRandomEngine *engine);
