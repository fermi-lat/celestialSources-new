...
class GRBmaker
{
 ...
 private:
	 ...
	 std::string baseFilename(const std::string &dir=0) const;

	 // Create "n" GRBs
	 void createGRB(const std::string &dir=0);

	 // Create GRB for specified input parameters
	 void createGRB(double duration, int npuls, double flux, double fraction, double powerLawIndex, bool flag);
	 ...
	 void readGRB(const std::string &fname);
