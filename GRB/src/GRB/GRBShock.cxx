...
{ 
  ...
  m_n1=m1*cst::c2/(cst::mpc2*Sh1->VolCom())*cst::erg2MeV;
...
double GRBShock::OpticalDepht(double ee)
{  
  double temp;
  ...
  temp=m_thickness;
  //  cout<<"--------------------"<<ee<<"--------------------"<<endl;
  // cout<<cst::st*cst::csi<<endl;
  // cout<<tsyn(ee)<<endl;
  // cout<<temp<<endl;
  // cout<<m_n1<<endl;
  //cout<<cst::st*cst::csi*m_n1*temp<<endl;
