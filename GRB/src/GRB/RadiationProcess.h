 ...
 *
 * \brief This class describe a generic radiative process
 * 
...
class RadiationProcess
{
 ...
 public:
   ...
   * that all the particle can rap[idly cool by this process.
   ...
   * To the particular radiation process has top be assign a cooling time, 
   * which conresponds to the time that a particle takes to emit its energy 
   ...
   * frame that is mooving with the radiative region (wich is mooving with a
   ...
   * \param E Observed photon energy (eV)
   * \param D Distance of the source, in cm
