  ...
  */
  ...
  for(i = 0; i < num_sources; i++)
      ...
      while(time<=time_max && nume<=events_max)
	{
      ...
      cout<<"Fluence [erg/cm^2]="<<fluence1/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
      cout<<"Fluence (0.05 MeV - 0.3 MeV) [erg/cm^2]="<<fluence2/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
      cout<<"Fluence (2.5 - 5 MeV) [erg/cm^2]="<<fluence3/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
      cout<<"Fluence (5 MeV - 10 MeV)[erg/cm^2]="<<fluence4/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
      cout<<"Fluence (10 MeV - 1GeV)[erg/cm^2]="<<fluence5/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
	...
	f2<<t1<<endl;
	f2<<(Area*1.0e+4)<<endl;
	f2<<fluence1/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
	f2<<fluence2/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
	f2<<fluence3/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
	f2<<fluence4/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
	f2<<fluence5/(Area*1.0e+4)*(1.0/erg2MeV)<<endl;
	f2.close();
      }
