  ...
  for(int i = 0; i<N ; i++)
    {
      ...
      os<<" <SpectrumClass name=\"GRBobsmanager\" params=\""<<BurstTime<<" , "<<Fluence<<" , "<<Npulses<<" , "<<alpha<<" , "<<beta<<" , "<<MinExtractedPhotonEnergy<<"\"/>"<<std::endl;
      os<<"<galactic_dir l=\""<<l<<"\" b=\""<<b<<"\" />"<<std::endl;
