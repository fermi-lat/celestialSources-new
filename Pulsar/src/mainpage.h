...
* At the moment there's included one default emission model, based on a phenomenological analytical form for the spectrum, based on a paper of Nel and DeJager (1995, see Ref.) and of DeJager (2002, see Ref.) that takes into account the spectral high energy cutoff. Using this model, in this tutorial is shown an example that describes how to create pulsar sources with a Polar Cap or Outer Gap scenario.
